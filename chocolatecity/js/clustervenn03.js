		...
		d3.csv("data/DC_Neighborhoodcircle_3.csv", function(error, data) {
		...
		//add cluster as a svg
				
		var black = g13.selectAll("circle")
			.data(data)
			.enter().append("circle")
			.style("fill", "#f28f00")
		...
		var white = g14.selectAll("circle")
			.data(data)
			.enter().append("circle")
			.style("fill", "#d21e2d")
			.style("fill-opacity", ".5")
		...
		var asian = g16.selectAll("circle")
			.data(data)
			.enter().append("circle")
			.style("fill", "#691ed2")
			.style("fill-opacity", ".5")
