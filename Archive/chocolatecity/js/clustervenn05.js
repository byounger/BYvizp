	...
	var svg = d3.select("#area7")
		...
		d3.csv("data/DC_Neighborhoodcircle_5.csv", function(error, data) {
...
//add cluster aka individual circles as a grouped svg object
		...
		var black = g21.selectAll("circle")
			.data(data)
			.enter().append("circle")
		...
		var white = g22.selectAll("circle")
			.data(data)
			.enter().append("circle")
		...
		var asian = g24.selectAll("circle")
			.data(data)
			.enter().append("circle")
