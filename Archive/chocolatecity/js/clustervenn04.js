	...
	var svg = d3.select("#area6")
		...
		d3.csv("data/DC_Neighborhoodcircle_4.csv", function(error, data) {
...
//add cluster aka individual circles as a grouped svg object
		...
		var black = g17.selectAll("circle")
			.data(data)
			.enter().append("circle")
		...
		var white = g18.selectAll("circle")
			.data(data)
			.enter().append("circle")
		...
		var asian = g20.selectAll("circle")
			.data(data)
			.enter().append("circle")
