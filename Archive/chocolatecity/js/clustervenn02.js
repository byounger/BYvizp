		...
		d3.csv("data/DC_Neighborhoodcircle_2.csv", function(error, data) {
		...
		var white = g10.selectAll("circle")
			.data(data)
			.enter().append("circle")
			.style("fill", "#d21e2d")
			.style("fill-opacity", ".5")
		...
		var asian = g12.selectAll("circle")
			.data(data)
			.enter().append("circle")
			.style("fill", "#691ed2")
			.style("fill-opacity", ".5")
